...
CREATE TABLE application(
	...
	,CONSTRAINT application_users_FK FOREIGN KEY (id_user) REFERENCES users(id_user)
...
CREATE TABLE wish_list(
	...
	,CONSTRAINT wish_list_users_FK FOREIGN KEY (id_user) REFERENCES users(id_user)
...
CREATE TABLE living(
	...
	,CONSTRAINT living_users0_FK FOREIGN KEY (id_user) REFERENCES users(id_user)
)ENGINE=InnoDB;
...
CREATE TABLE possessing(
	...
	,CONSTRAINT possessing_users0_FK FOREIGN KEY (id_user) REFERENCES users(id_user)
)ENGINE=InnoDB;
...
CREATE TABLE being_in_charge_of(
	...
	,CONSTRAINT being_in_charge_of_users0_FK FOREIGN KEY (id_user) REFERENCES users(id_user)
)ENGINE=InnoDB;
