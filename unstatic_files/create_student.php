...
<body>
    ...
    <br>
        <label>Student login</label> <br> <input type="text" name="pilot_login"/>
        <br><br>
        <label>Student password</label> <br> <input type="text" name="pilot_password"/>
        <br><br>
        <label>Student firstname</label> <br> <input type="text" name="pilot_firstname"/>
        <br><br>
        <label>Student lastname</label> <br> <input type="text" name="pilot_lastname"/>
        <br><br>
        <label>Student center</label> <br> <input type = "text" name = "pilot_center"/>
        <br><br>
        <label>Student promotions</label> <br> <input type = "text" name = "id_promotion"/>
        <br><br>
    ...
    <?php
        ...
        if(isset($_POST['save']))
        {
            ...
            FROM roles, users
            WHERE users.last_name = ? and roles.role_name = 'student';");
